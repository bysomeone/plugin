...
type BtcChainNode struct {
	...
	Work   []byte `protobuf:"bytes,3,opt,name=work,proto3" json:"work,omitempty"`
}

func (x *BtcChainNode) Reset() {
	*x = BtcChainNode{}
	if protoimpl.UnsafeEnabled {
...
func (x *BtcChainNode) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BtcChainNode) ProtoMessage() {}

func (x *BtcChainNode) ProtoReflect() protoreflect.Message {
	mi := &file_lightclient_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BtcChainNode.ProtoReflect.Descriptor instead.
func (*BtcChainNode) Descriptor() ([]byte, []int) {
	return file_lightclient_proto_rawDescGZIP(), []int{2}
}

func (x *BtcChainNode) GetHeight() uint64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *BtcChainNode) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *BtcChainNode) GetWork() []byte {
	if x != nil {
		return x.Work
	}
	return nil
...
type BtcChainState struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// nodes 按高度升序，最后一个即当前 canonical tip。
	Nodes []*BtcChainNode `protobuf:"bytes,1,rep,name=nodes,proto3" json:"nodes,omitempty"`
}

func (x *BtcChainState) Reset() {
	*x = BtcChainState{}
	if protoimpl.UnsafeEnabled {
...
func (x *BtcChainState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BtcChainState) ProtoMessage() {}

func (x *BtcChainState) ProtoReflect() protoreflect.Message {
	mi := &file_lightclient_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BtcChainState.ProtoReflect.Descriptor instead.
func (*BtcChainState) Descriptor() ([]byte, []int) {
	return file_lightclient_proto_rawDescGZIP(), []int{3}
}

func (x *BtcChainState) GetNodes() []*BtcChainNode {
	if x != nil {
		return x.Nodes
	}
	return nil
...
type BtcHeadersLog struct {
	...
	ForkHeight uint64 `protobuf:"varint,6,opt,name=forkHeight,proto3" json:"forkHeight,omitempty"`
	// canonicalSwitched 本批是否把 canonical tip 切换成了本批 tip（false = 本批是更轻的分叉，只验不切）。
	CanonicalSwitched bool `protobuf:"varint,7,opt,name=canonicalSwitched,proto3" json:"canonicalSwitched,omitempty"`
	// tipWork 本批 tip 的累积工作量（大端），便于排查"为什么没切换"。
	TipWork []byte `protobuf:"bytes,8,opt,name=tipWork,proto3" json:"tipWork,omitempty"`
	// reorgRuleVersion 写出本日志的规则版本；0 表示 B3/B4 之前的老日志（历史区块重放会看到），
	// ExecLocal 据此走兼容分支（只按高度写入、不做回退删除）。
	ReorgRuleVersion uint32 `protobuf:"varint,9,opt,name=reorgRuleVersion,proto3" json:"reorgRuleVersion,omitempty"`
}
...
func (x *BtcHeadersLog) GetForkHeight() uint64 {
	if x != nil {
		return x.ForkHeight
	}
	return 0
...
func (x *BtcHeadersLog) GetCanonicalSwitched() bool {
	if x != nil {
		return x.CanonicalSwitched
	}
	return false
}

func (x *BtcHeadersLog) GetTipWork() []byte {
	if x != nil {
		return x.TipWork
	}
	return nil
...
func (x *BtcHeadersLog) GetReorgRuleVersion() uint32 {
	if x != nil {
		return x.ReorgRuleVersion
	}
	return 0
}
...
type TssSignNotify struct {
	...
	InputAmounts []int64  `protobuf:"varint,1,rep,packed,name=inputAmounts,proto3" json:"inputAmounts,omitempty"`
	Payload      []byte   `protobuf:"bytes,2,opt,name=payload,proto3" json:"payload,omitempty"`
	TxType       string   `protobuf:"bytes,3,opt,name=txType,proto3" json:"txType,omitempty"`
	BtcTxData    []byte   `protobuf:"bytes,4,opt,name=btcTxData,proto3" json:"btcTxData,omitempty"`
	...
	Psbt []byte `protobuf:"bytes,6,opt,name=psbt,proto3" json:"psbt,omitempty"`
	// RGB20 提现：该笔转移的 consignment（签名节点 ValidateConsignment 用）。
	Consignment []byte `protobuf:"bytes,7,opt,name=consignment,proto3" json:"consignment,omitempty"`
}

func (x *TssSignNotify) Reset() {
	*x = TssSignNotify{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lightclient_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TssSignNotify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TssSignNotify) ProtoMessage() {}

func (x *TssSignNotify) ProtoReflect() protoreflect.Message {
	mi := &file_lightclient_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TssSignNotify.ProtoReflect.Descriptor instead.
func (*TssSignNotify) Descriptor() ([]byte, []int) {
	return file_lightclient_proto_rawDescGZIP(), []int{10}
}

func (x *TssSignNotify) GetInputAmounts() []int64 {
	if x != nil {
...
func (x *TssSignNotify) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *TssSignNotify) GetTxType() string {
	if x != nil {
		return x.TxType
	}
	return ""
...
func (x *TssSignNotify) GetBtcTxData() []byte {
	if x != nil {
		return x.BtcTxData
	}
	return nil
...
func (x *TssSignNotify) GetSigners() []string {
	if x != nil {
		return x.Signers
	}
	return nil
...
func (x *TssSignNotify) GetPsbt() []byte {
	if x != nil {
		return x.Psbt
	}
	return nil
...
func (x *TssSignNotify) GetConsignment() []byte {
	if x != nil {
...
func (x *ReqGetBtcHeader) Reset() {
	*x = ReqGetBtcHeader{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lightclient_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReqGetBtcHeader) Descriptor() ([]byte, []int) {
	return file_lightclient_proto_rawDescGZIP(), []int{11}
}
...
var file_lightclient_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x78, 0x74, 0x48, 0x61, 0x73, 0x68, 0x22, 0x4e, 0x0a, 0x0c, 0x42, 0x74, 0x63, 0x43,
	0x68, 0x61, 0x69, 0x6e, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x69, 0x67,
	...
	,
	...
	,
	...
	,
...
var file_lightclient_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_lightclient_proto_goTypes = []interface{}{
	(*LightClientAction)(nil), // 0: LightClientAction
	(*BtcHeader)(nil),         // 1: BtcHeader
	(*BtcChainNode)(nil),      // 2: BtcChainNode
	(*BtcChainState)(nil),     // 3: BtcChainState
	(*BtcHeadersLog)(nil),     // 4: BtcHeadersLog
	(*BtcHeaders)(nil),        // 5: BtcHeaders
	(*BtcTransaction)(nil),    // 6: BtcTransaction
	(*Vin)(nil),               // 7: Vin
	(*Vout)(nil),              // 8: Vout
	(*BtcSpv)(nil),            // 9: BtcSpv
	(*TssSignNotify)(nil),     // 10: tssSignNotify
	(*ReqGetBtcHeader)(nil),   // 11: reqGetBtcHeader
}
var file_lightclient_proto_depIdxs = []int32{
	5, // 0: LightClientAction.btcHeaders:type_name -> BtcHeaders
	2, // 1: BtcChainState.nodes:type_name -> BtcChainNode
	1, // 2: BtcHeaders.headers:type_name -> BtcHeader
	7, // 3: BtcTransaction.vin:type_name -> Vin
	8, // 4: BtcTransaction.vout:type_name -> Vout
...
func file_lightclient_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lightclient_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TssSignNotify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_lightclient_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
